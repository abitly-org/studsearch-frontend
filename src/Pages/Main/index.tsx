...
import MultyDropdowns from "../../Components/MultyDropdowns";
    ...
    <div className="MainPage">
      ...
      <div className="First" style={{ backgroundImage: `url(${bg})` }}>
        <div>
          <div className="Info">
            ...
            <ul>
              <li>
                <P1>{t("main-first-question1")}</P1>
              </li>
              <li>
                <P1>{t("main-first-question2")}</P1>
              </li>
              <li>
                <P1>{t("main-first-question3")}</P1>
              </li>
              <li>
                <P1>{t("main-first-question4")}</P1>
              </li>
            </ul>
            <br />
      ...
      <div className="Third">
        ...
        {stat && (
          <Button to="/students/">
            <P2>
              {t(plural("main-third-button", stat?.studentsCount - 3), {
...
function getFaculty(query: any, id: number, count: any, offset: any): any {
